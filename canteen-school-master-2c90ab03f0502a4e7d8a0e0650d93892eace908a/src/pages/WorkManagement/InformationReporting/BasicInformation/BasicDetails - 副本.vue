      ...
      <div>
         ...
         <div v-if="school_type==0">
           <div class="titles">
            ...
            <div class="iptBox">
              <div>
                <p>食材：{{allData.expenditure.last_year_food}}元</p>
              </div>
              <div>
                <p>人工：{{allData.expenditure.last_year_people}}元</p>
              </div>
              <div>
                <p>运行费及其他：{{allData.expenditure.last_year_other}}元</p>
              </div>
            </div>
         </div>
         <div v-if="school_type==0">
           <div class="titles">
            ...
            <div class="iptBox">
              <div>
                <p>食材：{{allData.expenditure.now_year_food}}元</p>
              </div>
              <div>
                <p>人工：{{allData.expenditure.now_year_people}}元</p>
              </div>
              <div>
                <p>运行费及其他：{{allData.expenditure.now_year_other}}元</p>
              </div>
            </div>
         </div>
      </div>
